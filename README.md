...
The application will eventually accept a user-selected Ryujinx directory rather than relying on a fixed OS path. This includes Windows directories mounted under WSL, such as `/mnt/c/Users/.../`.
